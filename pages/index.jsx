  ...
  return (
    <>
      ...
      <div className="text-center py-8 text-3xl">
        Rafał Fatuła -Projekt zaliczeniowy
      </div>
      <div className="flex flex-row">
        <div className='flex flex-col-reverse w-1/4 gap-4 m-4 justify-center items-center'>
          ...
          <div className="flex flex-col gap-4">
            ...
            <label>
              BX
              <input type="text" name="BX" maxLength="4" value={registers.BX} onChange={(event) => handleChange(event)} />
            </label>
            <label>
              CX
              <input type="text" name="CX" maxLength="4" value={registers.CX} onChange={(event) => handleChange(event)} />
            </label>
            <label>
              DX
              <input type="text" name="DX" maxLength="4" value={registers.DX} onChange={(event) => handleChange(event)} />
            </label>
          </div>
        </div>
        <div className='flex flex-row w-3/4 gap-4 m-4 justify-end'>
